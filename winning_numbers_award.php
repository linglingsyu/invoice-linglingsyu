...
<body class="d-flex justify-content-center align-items-center">
    ...
    ?>
        <form action="?" method="post">
            ...
            <h1 class="h3 my-3 text-center">對獎</h1>
            ...
            <?php  
                ...
                if(isset($_GET["award"]) && $_GET["award"] == 0 ){
                    if(!empty($_GET["num"])){
                        echo "<div class='text-center text-warning'>發票後三碼" . $_GET["num"] ."沒有中獎</div>";
                    }else{
                        echo "<div class='text-center text-warning'>請輸入發票後三碼</div>";
                    }
                }
            ...
            if (!isset($_POST["numlast3"]) && !isset($_POST["number5"])) {
                ...
                if (in_array($numlast3, $lastthree)) {
                    ...
                    echo '<input type="submit" class="form-contorl" value="送出">';
                    echo '</form>';
                    exit();
                }
                to("winning_numbers_award.php?award=0&num=$numlast3");
                ...
                if ($number == $special) {
                    ...
                    echo "發票號碼" . $number . "中了<span class='text-warning'>特別獎</發票號碼>，獎金<span class='text-warning'>1000萬</span>元";
                    exit();
                } elseif ($number == $top) {
                    echo "<img src='img/q20.gif' class='rounded'>";
                    echo "發票號碼" . $number . "中了<span class='text-warning'>特獎</span>，獎金<span class='text-warning'>200萬</span>元";
                    exit();
                } elseif ($number == $first_prize1 || $number == $first_prize2 || $number == $first_prize3) {
                    echo "發票號碼" . $number . "中了<span class='text-warning'>頭獎</span>，獎金<span class='text-warning'>20萬</span>元";
                    exit();
                } elseif (in_array(substr($number, 1, 7), $second)) {
                    echo "<img src='img/q20.gif' class='rounded'>";
                    echo "發票號碼" . $number . "中了<span class='text-warning'>二獎</span>，獎金<span class='text-warning'>4萬</span>元";
                    exit();
                } elseif (in_array(substr($number, 2, 6), $third)) {
                    echo "<img src='img/q20.gif' class='rounded'>";
                    echo "發票號碼" . $number . "中了<span class='text-warning'>三獎</span>，獎金<span class='text-warning'>1萬</span>元";
                    exit();
                } elseif (in_array(substr($number, 3, 5), $fourth)) {
                    echo "<img src='img/q20.gif' class='rounded'>";
                    echo "發票號碼" . $number . "中了<span class='text-warning'>四獎</span>，獎金<span class='text-warning'>4千</span>元";
                    exit();
                } elseif (in_array(substr($number, 4, 4), $fifth)) {
                    echo "<img src='img/q20.gif' class='rounded'>";
                    echo "發票號碼" . $number . "中了<span class='text-warning'>五獎</span>，獎金<span class='text-warning'>1千</span>元";
                    exit();
                } elseif (in_array($number3, $sixth)) {
                    echo "<img src='img/q20.gif' class='rounded'>";
                    echo "發票號碼" . $number . "中了<span class='text-warning'>六獎</span>，獎金<span class='text-warning'>2百</span>元";
                }else{
                    echo "<span class='text-warning'>很可惜，發票號碼" . $number . "沒有中獎</span>";
                }
                echo "</div>";
            }
            ?>
